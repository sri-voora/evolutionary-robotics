...
def Generate_Brain():
    ...
    sensorNeurons=[0,1,2]
    motorNeurons=[3,4]
    for sensorNeuronName in sensorNeurons:
        for motorNeuronName in motorNeurons:
            pyrosim.Send_Synapse(sourceNeuronName=sensorNeuronName, targetNeuronName=motorNeuronName, weight=random.uniform(-1,1))
